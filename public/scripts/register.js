$(document).ready(function () {
  ...
  $('.submit').click(function(e){
    ...
    $.ajax({
      ...
      // $('.container').empty();
      console.log('should empty the container now')
      // window.location.replace('/users/new')
      console.log('should be sending you back to new user page now')
      $('.register-alert').append(`
      <div class="alert alert-warning alert-dismissible fade show" role="alert">
      <strong>OOPS!</strong> Didn't work
      <button type="button" class="close" data-dismiss="alert" aria-label="Close">
        <span aria-hidden="true">&times;</span>
      </button>
      </div>
      `)
      console.log('alert should display now')
